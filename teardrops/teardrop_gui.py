...
class teardrop_gui ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Teardrops fixed", pos = wx.DefaultPosition, size = wx.Size( 450,368 ), style = wx.CAPTION|wx.CLOSE_BOX|wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER )
